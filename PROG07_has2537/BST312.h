//
// Created by Hasna Sharif on 11/16/20.
//
...
{
    vector<ItemType> resolve;
    preOrderTraversal(root, resolve);
    return resolve;
...
vector<ItemType> BST_312 <ItemType>::postOrderTraversal() {
    if (root == NULL) {
        ...
        vector<ItemType> postraverse;
        postOrderTraversal(root, postraverse);
        return postraverse;
    }
}
